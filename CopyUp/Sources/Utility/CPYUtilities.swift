...
final class CPYUtilities {
    ...
    static func registerUserDefaultKeys() {
        ...
        defaultValues.updateValue(NSNumber(value: 30), forKey: Constants.UserDefaults.numberOfItemsPlaceInline)
        ...
        defaultValues.updateValue(NSNumber(value: false), forKey: Constants.UserDefaults.menuItemsAreMarkedWithNumbers)
